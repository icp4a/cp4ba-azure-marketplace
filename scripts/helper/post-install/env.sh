...
############################################
PROBE_USER_API_KEY="Dbl8TcjH7byojKRpUyFiV1aU2ppBikvCBpksfWgt"   # user Api Key generated from CP4BA console
PROBE_USER_NAME="CEadmin"      # user name, user who has right to open all CP4BA links
PROBE_USER_PASSWORD="Genius1"  # user password for basic authentication
