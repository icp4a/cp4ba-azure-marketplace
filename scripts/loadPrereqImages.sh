...
function loginEntitlementRepo() {
    ...
    printf "\x1B[1mhttps://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/23.0.2?topic=deployment-getting-access-images-from-public-entitled-registry\n\x1B[0m"
